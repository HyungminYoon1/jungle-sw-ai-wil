...
- Status: Superseded by 2026-06-12 decision
...
## 2026-06-12 - 공통 게시판 포맷 기반 AI 게시판 구현 일정 확정

- Status: Decided
- Context: 각자 게시판 구현 시간을 확보하면서도, 이후 결과물을 비교하고 RAG와 AI Agent 적용 방향을 맞추기 위한 공통 시작 기준이 필요하다.
- Decision: 2026-06-13 18:00까지 각자 게시판을 구현하고, 2026-06-13 19:00부터 공통 게시판 포맷을 이용해 개인 아이디어와 RAG, AI Agent를 적용한 게시판을 구현한다.
- Reason: 기본 게시판 구현 경험을 먼저 확보한 뒤 공통 포맷 위에서 AI 기능을 붙이면 개인별 아이디어는 유지하면서도 데모와 비교 기준을 맞출 수 있다.
- Consequence: 2026-06-13 18:00까지는 각자 게시판 구현 완료와 흐름 점검에 집중한다. 19:00 이후에는 공통 게시판 포맷을 기준으로 개인 AI 기능 구현과 설명 가능한 데모 준비를 진행한다.
